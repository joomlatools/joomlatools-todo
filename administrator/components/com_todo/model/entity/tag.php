 ...
 */
class ComTodoModelEntityTag extends KModelEntityRow
{
	/**
	...
	{
			//Delete the tag
			$relation = $this->getObject('com:todo.model.entity.relation');
			...
			if($this->row && $this->table)
	 		{
					$relation = $this->getObject('com:todo.model.entity.relation', array('status' => Database::STATUS_FETCHED));
					$relation->tags_tag_id = $this->id;
