...
--
-- Dumping data for table `#__todo_items`
--

INSERT INTO `#__todo_items` (`todo_item_id`, `uuid`, `title`, `slug`, `description`, `enabled`, `locked_on`, `locked_by`, `created_on`, `created_by`, `modified_on`, `modified_by`, `params`) VALUES
