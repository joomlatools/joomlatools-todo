                    ...
                    <ul class="k-navigation">
                        <li class="active">
                            <a href="form.html">
                                ...
                                <span class="k-title collapsible">Todos</span>
                            </a>
                        </li>
                        <li>
                            <a href="form.html">
                                <span class="k-icon-grid"></span>
                                <span class="k-title collapsible">Activities</span>
                            </a>
                        </li>
                        <li>
                            <a href="form.html">
                                <span class="k-icon-settings"></span>
                                <span class="k-title collapsible">Categories</span>
                            </a>
                        </li>
                    </ul>
                </div>
